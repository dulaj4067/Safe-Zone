...
void main() {
  testWidgets('resume dropdown hides when empty and shows badge count', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
        home: ResumeDropdown(items: const [], onResume: (_) {}),
      ),
    );
  ...
  testWidgets('resume dropdown can expand when emergency alert is active', (
    tester,
  ) async {
    final items = [
      ResumeItem(
    ...
    await tester.tap(find.text('Resume where you left off'));
